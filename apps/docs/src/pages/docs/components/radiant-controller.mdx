...
`startControllers(...)` is a real public subpath export from `@ecopages/radiant/controller-registry`. Use it when a DOM subtree should opt into controller discovery.
