...
export const getMetadata = () => ({
	title: 'Docs | Slots',
	description: 'Project authored light-DOM content through default and named slots in RadiantComponent.',
})

# Slots

`RadiantComponent` supports default and named slots through literal `<slot>` tags in `render()`.
