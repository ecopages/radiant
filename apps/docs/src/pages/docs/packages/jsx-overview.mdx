...
`@ecopages/jsx` declares `@ecopages/signals` as a peer dependency. Install it when you use `mapSubscribable(...)` with signal-like sources or when you mix standalone signals into JSX templates.
