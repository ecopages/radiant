...
If you need host-owned async state built on top of signals, use the public subpath `@ecopages/radiant/signals/host-resource` documented in [Resources](/docs/packages/signals-resources).
