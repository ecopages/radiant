...
- [RadiantElement](/docs/components/radiant-element) for host-owned render lifecycle
- [Component SSR](/docs/ssr/component-ssr) for `renderComponent(...)` and the server pipeline
