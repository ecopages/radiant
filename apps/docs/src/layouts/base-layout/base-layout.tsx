...
export type BaseLayoutProps = {
	...
	class?: string;
	/** When `false`, omit the site header (docs uses `RuiSidebarProvider` site chrome). */
	showHeader?: boolean;
};

const GitHubIcon = () => (
	<svg width="24" height="24" viewBox="0 0 98 96" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
		<title>GitHub</title>
					...
					<header class="site-header">
						<div class="site-header__inner">
							<div class="site-header__start">
								...
								<p class="site-header__version">v {rootJson.version}</p>
							</div>
