...
The host queries `.rui-hover-card__trigger` for focus events and `[data-hover-card-trigger]` for the anchor.
...
| `.rui-hover-card__trigger` | yes | — | focus bridge around the anchor |
...
| --- | --- | --- |
| `RuiHoverCardTrigger` | `[data-hover-card-trigger]` inside `.rui-hover-card__trigger` | Anchor for hover/focus. |
