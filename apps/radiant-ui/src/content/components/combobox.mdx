...
import { meta as ComboboxMeta, Default, Multiple, TriggerKindManual } from '@/content/stories/combobox';
...
<Canvas of={Multiple} meta={ComboboxMeta} />
...
<Canvas of={TriggerKindManual} meta={ComboboxMeta} />
