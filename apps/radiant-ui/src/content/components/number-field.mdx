...
| `name` | `string` | `''` | Form field name on this host. Submits the raw number, not the formatted display. |
...
| --- | --- | --- |
| `RuiNumberField` | default group when `children` omitted | Includes input and steppers. |
