...
| `[data-select-trigger]` | yes | `role`, `aria-expanded`, `aria-controls`, `aria-haspopup`, `id`, `disabled` | the button |
...
| `RuiSelectTrigger` | `[data-select-trigger]` | Place `RuiSelectValue` inside |
