...
| --- | --- | --- | --- |
| `[data-ref="form"]` or `form.rui-form` | yes | `id` when wiring orphan submits | native `<form noValidate>` and field children |
...
| --- | --- | --- |
| `RuiForm` | `form.rui-form` with `[data-ref="form"]` | Passes `defaultValues`, `resolver`, `onSubmit` via `prop:` bindings. |
