...
export type DocsLayoutProps = { children: JsxRenderable };

const SIDEBAR_ID = 'radiant-ui-sidebar';
const ECO_NAVIGATION_EVENTS = 'eco:page-load,eco:after-swap';

const RadiantLogo = ({ href = '/' }: { href?: string }) => (
	<a href={href} class="ui-logo" title="Radiant UI" aria-label="Radiant UI home">
	...
	<div class="rui-sidebar-provider__site-header-inner">
		...
		<nav class="rui-sidebar-provider__site-header-nav" aria-label="Site">
			<a
				...
				class="rui-sidebar-provider__site-header-link"
			...
			<theme-toggle id="toggle-dark-mode-docs">
